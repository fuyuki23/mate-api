...
public class MateRestControllerAdvice {
  ...
  public ResponseEntity<?> httpRequestMethodNotSupportedException(
    ...
    return ResponseEntity.status(HttpStatus.METHOD_NOT_ALLOWED)
        .body(DefaultError.METHOD_NOT_ALLOWED.toMap());
  }
  ...
  public ResponseEntity<?> authorizationDeniedException(AuthorizationDeniedException e) {
    return ResponseEntity.status(HttpStatus.FORBIDDEN).body(DefaultError.FORBIDDEN.toMap());
  }
  ...
  public ResponseEntity<?> unknownException(Exception e) {
    ...
    return ResponseEntity.status(HttpStatus.INTERNAL_SERVER_ERROR)
        .body(DefaultError.INTERNAL_SERVER_ERROR.toMap());
  }
